...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-ZNIGfMoq.mjs");
...
var manifest = { "a88cc7d4b39ffdfbb64eecc6eaed2f41226f281c8d1accde7a01385783b63d7a": {
	functionName: "runEvalSuite_createServerFn_handler",
	importer: () => import("./eval-DHiTu89s.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DexoqVMW.mjs").then((n) => n.t),
